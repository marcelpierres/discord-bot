...
constructor(client){
    ...
    async run(msg, args){
        ...
        .setTitle('__**TECHNOLOGY NEWS RULES**__')
        ...
        .addField("Technology-News","This channel is used to talk about any **News In The Tech World** , share info about your favourite tech and have fun!")
