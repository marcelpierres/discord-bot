...
constructor(client){
    ...
    async run(msg, args){
        ...
        .setTitle('__**EDUCATIONAL VIDEOS RULES**__')
        ...
        .addField("Educational-Videos","This channel is used to share any **Educational videos** pertaining to **Coding**, if you want to drop your favourite tutorials, you can do that here.")
